...
class coman_control
{
    ...
    double tauSens[NUM];
    double forceRightAnkle[3], forceLeftAnkle[3], forceRightHand[3], forceLeftHand[3], torqueLeftAnkle[3], torqueRightAnkle[3];
    ...
    string prefix = "/island_1/robot_1"; // Load with ROSPARAM
    string control_prefix = prefix + "/control/config";
};